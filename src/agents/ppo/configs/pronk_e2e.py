...
from src.envs.configs import pronk_e2e
...
def get_training_config():
  ...
  runner_config.experiment_name = "pronk_e2e"
...
def get_config():
  ...
  config.env_class = jump_env_e2e.JumpEnvE2E
  config.environment = pronk_e2e.get_config()
  return config
